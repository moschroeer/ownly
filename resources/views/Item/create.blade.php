    ...
    <form action="/items" method="post">
        ...
        <div class="max-w-md my-4">
            ...
            <input type="text" name="title"
                   class="bg-gray-200 p-2 rounded-md w-full mt-1"
            />
        </div>

        <div class="max-w-md my-4">
            <label for="description"> Description:</label><br/>
            <textarea name="description" class="bg-gray-200 p-2 rounded-md text-gray-400 w-full min-h-40 mt-1">Describe your item</textarea>
        </div>
